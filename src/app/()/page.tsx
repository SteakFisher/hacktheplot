...
const BottomGradient = () => {
  return (
    <>
      <span className="group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0" style={{background: 'linear-gradient(to right, transparent, var(--halloween-orange), transparent)'}} />
      <span className="group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-1/2 mx-auto -bottom-px inset-x-10" style={{background: 'linear-gradient(to right, transparent, var(--halloween-red), transparent)'}} />
    </>
  );
};
